...
```{R import and clean dataset unemployment}
...
```{R merge the datasets and arrange by year and month}
merged <-
...
**171** unique ZIP codes exist in the ZIP code dataset but not in the Zillow dataset — for example,  
