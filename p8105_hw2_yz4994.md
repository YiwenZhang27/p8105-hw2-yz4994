...
The comnined trash wheel data has **1016** observations. The dataset
`mr.trash_df` include **707** dumpsters. The dataset
`professor_trash_df` include **117** dumpsters. The dataset
`gwynnda_trash_df` include **192** dumpsters.
...
Trash Wheel was **244.69** tons. In June 2022, Gwynnda collected a total
of **0** cigarette butts. However, we could find that the 0 cigarette
butts is from the new and processed dataset which drops the rows with
missing data. The original dataset shows that 18120 cigarette butts in
June 2022.
